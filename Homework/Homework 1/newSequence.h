...
class Sequence
{
  public:
    ...
    Sequence(int s); // Create an empty sequence with a max number s of items.
    Sequence(const Sequence& n); // Copy constructor
    Sequence& operator=(const Sequence& n); // Assignment operator
    ~Sequence(); // Destructor
